...
print("Question 1")
values = read_values_from_file(r"C:\Users\6293368\Downloads\values.txt")
print("Values: ", values)
...
def read_oscillatory_wave_data(filename):
    ...
    return data1, mean_amplitude, max_amplitude
print("Question 2")
data1, mean_amplitude, max_amplitude = read_oscillatory_wave_data(r"C:\Users\6293368\Downloads\test_oscillatory_wave.csv")
...
print("Question 3")
data, wave_speeds = read_standing_wave_data(r"C:\Users\6293368\Downloads\standing_wave.csv")
